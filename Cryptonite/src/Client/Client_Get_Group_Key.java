...
import Server.Server_Code_Manager;
...
public class Client_Get_Group_Key implements PacketRule
{
	...
	public SecretKey running(String groupCode,int keynum)		//keynum 0 = fileupload : 그냥 그룹aeskey 리턴	//non-zero = filedownload : 해당 keynum의 key
	{
