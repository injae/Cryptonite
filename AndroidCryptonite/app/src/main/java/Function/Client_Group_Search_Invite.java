 ...
 */
public class Client_Group_Search_Invite implements PacketRule{

    private Client_Server_Connector css;
    private static Client_Group_Search_Invite cgs;
    private FloatingSearchView searchView;
    public Queue<String> queue = new LinkedList<>();

    private Client_Group_Search_Invite(FloatingSearchView searchView){
        css = Client_Server_Connector.getInstance();
        this.searchView = searchView;
    }


    public static Client_Group_Search_Invite getInstance(FloatingSearchView searchView){
        //       if (cgs == null)
        //      {
        cgs = new Client_Group_Search_Invite(searchView);
        //      }
        return cgs;
    }
